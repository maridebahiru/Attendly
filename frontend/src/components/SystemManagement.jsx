    ...
    const fetchSettings = async () => {
      try {
        ...
        setSettings({
          ...
          morning_in_start: data.morning_in_start || '02:00',
          morning_in_end: data.morning_in_end || '03:00',
          morning_out_start: data.morning_out_start || '05:00',
          morning_out_end: data.morning_out_end || '07:00',
          afternoon_in_start: data.afternoon_in_start || '08:00',
          afternoon_in_end: data.afternoon_in_end || '09:00',
          afternoon_out_start: data.afternoon_out_start || '10:00',
          afternoon_out_end: data.afternoon_out_end || '12:00'
        });
      } catch (err) {
